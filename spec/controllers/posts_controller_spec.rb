...
RSpec.describe PostsController, type: :controller do
  ...
  let(:moderator) {User.create!(name: RandomData.random_name, email: RandomData.random_email, password: "password", role: :moderator) }
  ...
  context "moderator user doing CRUD on a post they don't own" do
    ...
    describe "POST create" do
      ...
      it "redirects them to the newly created post" do
        post :create, topic_id: my_topic.id, post: {title: RandomData.random_sentence, body: RandomData.random_paragraph}
        expect(response).to redirect_to [my_topic, Post.last]
      end
    end
